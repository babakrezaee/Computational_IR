...
plot(lstat,medv,
      col='grey',cex=.75,
     xlab='Low Status Percent',ylab = 'Median Value($)', main=TeX('$Y=\\alpha + \\beta X$'))
...
plot(lstat,medv,xlab='Low Status (%)',ylab = 'Median Value($)', col="gray45")
...
cat("kNN15: the median value of a house in a neighborhood with 20% low status residents is",round(kf15_20$fitted,digits=2),"\n")
...
plot(lstat,medv,col='maroon', lwd=2,
     xlab='Low Status (%)', ylab='Median Housing Price')
...
plot(lstat_s,dis_s,col='gray45', lwd=2,
     xlab='Low Status Population (%)', ylab='Distance',
     main='k=25', pch=19)
...
ndocv=35 # Number of cross validation
