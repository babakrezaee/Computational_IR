...
api_key <- "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"

text_input <- "In a few short sentences tell us about Leiden Univeristy."
...
Tone (e.g., formal, urgent, diplomatic, critical)
To keep the output focused, we will limit the printed response to only the relevant content—the model’s analysis of the tweet.
...
response_text <- send_to_gpt(text_input, api_key)
print(response_text$choices[[1]]$message$content)
...
Next, we will import a dataset of NATO’s tweets from a CSV file.
This dataset contains recent tweets from NATO’s official Twitter/X account.
